...
VLANTagBaseDescriptor::VLANTagBaseDescriptor() : omnetpp::cClassDescriptor("nesting::VLANTagBase", "inet::TagBase")
{
...
VLANTagReq::VLANTagReq() : ::nesting::VLANTagBase()
{
}

VLANTagReq::VLANTagReq(const VLANTagReq& other) : ::nesting::VLANTagBase(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::nesting::VLANTagBase::operator=(other);
    copy(other);
    return *this;
}
...
{
    doParsimPacking(b,(::nesting::VLANTagBase&)*this);
}

void VLANTagReq::parsimUnpack(omnetpp::cCommBuffer *b)
{
    doParsimUnpacking(b,(::nesting::VLANTagBase&)*this);
}
...
VLANTagReqDescriptor::VLANTagReqDescriptor() : omnetpp::cClassDescriptor("nesting::VLANTagReq", "nesting::VLANTagBase")
{
    propertynames = nullptr;
}
...
VLANTagInd::VLANTagInd() : ::nesting::VLANTagBase()
{
}

VLANTagInd::VLANTagInd(const VLANTagInd& other) : ::nesting::VLANTagBase(other)
{
    copy(other);
}
...
VLANTagIndDescriptor::VLANTagIndDescriptor() : omnetpp::cClassDescriptor("nesting::VLANTagInd", "nesting::VLANTagBase")
{
    propertynames = nullptr;
}
